...
const EXCEL_PATH = 'migracion_coop/julio/SOCIOS - CONSOLIDADO PAGOS 01-08 JULIO 2026.xlsx';
const SHEET_NAME = 'Detalle pagos';
const OUTPUT_SQL = 'supabase/migrations/00089_cargar_pagos_1_8_julio_2026.sql';
...
const MANUAL_MAP = {
  'MAYHUASCA CLUDY': 90, // Excel: "MAYHUASCA  CLUDY" (doble espacio) → MAYHUASCA BASTIDAS DE TORRES CLUDDY AYDE
};
