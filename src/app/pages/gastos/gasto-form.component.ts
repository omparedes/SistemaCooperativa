    ...
    <div class="fixed inset-0 bg-black/50 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-2xl w-full max-w-lg p-6 border border-gray-200 dark:border-gray-700">
        ...
        <div class="space-y-4">
          ...
          <!-- Total (Monto) -->
          <div>
            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Total (Monto) S/</label>
          ...
          <div>
            ...
            <textarea rows="3"
              ...
              (ngModelChange)="actualizar('descripcion', $event || null)"
          ...
          <div>
            ...
            <input type="text"
              ...
              (ngModelChange)="actualizar('comprobante_ref', $event || null)"
              class="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-900 text-gray-900 dark:text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-500" />
          </div>
        ...
        <div class="mt-6 flex justify-end gap-2">
          <button type="button" (click)="cancel.emit()"
            class="px-4 py-2 bg-gray-100 dark:bg-gray-700 hover:bg-gray-200 dark:hover:bg-gray-600 text-gray-800 dark:text-gray-200 rounded-lg transition">
            Cancelar
          </button>
          <button type="button" (click)="onSave()"
            class="px-4 py-2 bg-brand-600 hover:bg-brand-700 text-white rounded-lg shadow-sm transition">
            Guardar
          </button>
        </div>
      </div>
